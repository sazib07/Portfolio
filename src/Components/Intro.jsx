   ...
   <h1 className="ml-[10px] pb-[20px] text-[12px] sm:text-[22px] md:text-[28px] lg:text-[32px] mt-3 sm:mt-5 md:mt-6 bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400">
     ...
     <h2 className="ml-[10px] mb-[30px] text-[20px] sm:text-[36px] md:text-[50px] lg:text-[64px] xl:text-[72px] text-teal-100 font-bold mt-2 sm:mt-3 md:mt-4 leading-tight">
      ...
      <a
              href="/resume.png"
              download
              className="inline-flex mt-[10px] ml-2.5 items-center gap-2 px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm md:text-base bg-gradient-to-r from-blue-500 to-indigo-600 text-purple-200 font-mono rounded-lg shadow-lg shadow-indigo-500/40 hover:scale-105 hover:shadow-indigo-500/70 transition-all duration-300"
            >
              <FaDownload/>
              Resume
            </a>
